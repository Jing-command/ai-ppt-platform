...
class OutlineBackground(BaseModel):
    ...
    type: str = Field(
        default="ai",
        description="背景类型: ai, upload, solid"
    )
...
class OutlineGenerateRequest(BaseModel):
    ...
    context_data: Optional[Dict[str, Any]] = Field(None, alias="contextData", description="上下文数据")
...
class OutlineToPresentationRequest(BaseModel):
    ...
    slide_layout: str = Field(default="auto", alias="slideLayout", description="幻灯片布局: auto, detailed, minimal")
    generate_content: bool = Field(default=True, alias="generateContent", description="是否使用AI生成详细内容")
